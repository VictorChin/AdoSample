...
namespace ConsoleApplication1 {
    ...
    public partial class DsProducts : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(string Name, string Description, string Category, decimal Price) {
...
namespace ConsoleApplication1.DsProductsTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductId] = @Original_ProductId) AND ([Nam" +
                "e] = @Original_Name) AND ([Description] = @Original_Description) AND ([Category]" +
                " = @Original_Category) AND ([Price] = @Original_Price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Name], [Description], [Category], [Price]) VALUES " +
                "(@Name, @Description, @Category, @Price);\r\nSELECT ProductId, Name, Description, " +
                "Category, Price FROM Products WHERE (ProductId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Name] = @Name, [Description] = @Description, [Category] = @Category, [Price] = @Price WHERE (([ProductId] = @Original_ProductId) AND ([Name] = @Original_Name) AND ([Description] = @Original_Description) AND ([Category] = @Original_Category) AND ([Price] = @Original_Price));
SELECT ProductId, Name, Description, Category, Price FROM Products WHERE (ProductId = @ProductId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ConsoleApplication1.Properties.Settings.Default.SportsStoreConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, Name, Description, Category, Price FROM dbo.Products";
        ...
        public virtual int Delete(int Original_ProductId, string Original_Name, string Original_Description, string Original_Category, decimal Original_Price) {
        ...
        public virtual int Insert(string Name, string Description, string Category, decimal Price) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Description, string Category, decimal Price, int Original_ProductId, string Original_Name, string Original_Description, string Original_Category, decimal Original_Price, int ProductId) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, string Category, decimal Price, int Original_ProductId, string Original_Name, string Original_Description, string Original_Category, decimal Original_Price) {
            return this.Update(Name, Description, Category, Price, Original_ProductId, Original_Name, Original_Description, Original_Category, Original_Price, Original_ProductId);
        }
    }
